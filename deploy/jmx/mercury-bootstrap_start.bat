...
set MEM_OPTIONS=-Xms128m -Xmx128m -Xss512k -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=128m -XX:MaxDirectMemorySize=128m -Dapollo.configService=http://db.f-li.cn:8080 -Denv=pro
