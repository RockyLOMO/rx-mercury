...
set MEM_OPTIONS=-Xms256m -Xms256m -Xss512k -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=256m -XX:MaxDirectMemorySize=256m -Dapollo.configService=http://db.f-li.cn:8080 -Denv=pro
